...
$report | select Date,Hostname,ClientID,pxeparameter1,pxeparameter2,pxeparameter3 | export-csv "\\mdtp\DeploymentShare$\Scripts\SIT\Serverscripts\WDS_PXE\$filename.csv" -NoTypeInformation