# SEWY_Edit for connection via SQL user without Windows Authentication for Windows PE use
...
function Connect-MDTDatabase {
    ...
    else
    {
        ...
        $mdtSQLConnectString = "$mdtSQLConnectString; Database='$database'; User Id='$user'; Password='$password';"
    }
